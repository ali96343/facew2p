...
@auth.requires_login()
def dcollapsedIIsidebarform1ctrl():
    response.view = 'myadd/dcollapsedIIsidebarform1ctrl.html'
    return dict(grid= mygrid('dcollapsedIIsidebarform1'))
#
...
@auth.requires_login()
def dreadIImailform1ctrl():
    response.view = 'myadd/dreadIImailform1ctrl.html'
    return dict(grid= mygrid('dreadIImailform1'))
#
...
@auth.requires_login()
def dcomposeform1ctrl():
    response.view = 'myadd/dcomposeform1ctrl.html'
    return dict(grid= mygrid('dcomposeform1'))
#
