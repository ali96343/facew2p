...
# -------------------------------------------------------------------------
# auth.enable_record_versioning(db)##https://stackoverflow.com/questions/10201300/how-can-i-create-new-auth-user-and-auth-group-on-web2py-running-on-google-app-en
def check_initialize():
    if not db().select(db.auth_user.ALL).first():
        uid= db.auth_user.insert(
            username = 'administrator',
            password = db.auth_user.password.validate('xyz12345')[0],
            email = 'nil@nil.com',
            first_name = 'Main',
            last_name = 'User1',
        )
