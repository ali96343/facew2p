...
def boxed():
    ...
    boxedform0.element('input[name=f0]')['_id']='id_for878'
    ...
    boxedform0.custom.submit['_value'] = 'unk_882'
    ...
    boxedform1.element('input[name=f0]')['_placeholder']='f0 place_887'
    boxedform1.element('input[name=f0]')['_id']='id_for884'
    boxedform1.element('input[name=f0]')['_class']='pull-right'
    boxedform1.element('input[name=f1]')['_placeholder']='f1 place_891'
    boxedform1.element('input[name=f1]')['_id']='id_for888'
    boxedform1.element('input[name=f1]')['_class']='pull-right'
    boxedform1.element('input[name=f2]')['_placeholder']='f2 place_895'
    boxedform1.element('input[name=f2]')['_id']='id_for892'
    boxedform1.element('input[name=f2]')['_class']='pull-right'
    boxedform1.element('input[name=f3]')['_placeholder']='f3 place_899'
    boxedform1.element('input[name=f3]')['_id']='id_for896'
    boxedform1.element('input[name=f3]')['_class']='pull-right'
    boxedform1.element('input[name=f4]')['_placeholder']='f4 place_903'
    boxedform1.element('input[name=f4]')['_id']='id_for900'
    boxedform1.element('input[name=f4]')['_class']='pull-right'

    boxedform1.custom.submit['_id'] = 'id_for904'
...
def fixed():
    ...
    fixedform0.element('input[name=f0]')['_id']='id_for717'
    ...
    fixedform0.custom.submit['_value'] = 'unk_721'
    ...
    fixedform1.element('input[name=f0]')['_placeholder']='f0 place_726'
    fixedform1.element('input[name=f0]')['_id']='id_for723'
    fixedform1.element('input[name=f0]')['_class']='pull-right'
    fixedform1.element('input[name=f1]')['_placeholder']='f1 place_730'
    fixedform1.element('input[name=f1]')['_id']='id_for727'
    fixedform1.element('input[name=f1]')['_class']='pull-right'
    fixedform1.element('input[name=f2]')['_placeholder']='f2 place_734'
    fixedform1.element('input[name=f2]')['_id']='id_for731'
    fixedform1.element('input[name=f2]')['_class']='pull-right'
    fixedform1.element('input[name=f3]')['_placeholder']='f3 place_738'
    fixedform1.element('input[name=f3]')['_id']='id_for735'
    fixedform1.element('input[name=f3]')['_class']='pull-right'
    fixedform1.element('input[name=f4]')['_placeholder']='f4 place_742'
    fixedform1.element('input[name=f4]')['_id']='id_for739'
    fixedform1.element('input[name=f4]')['_class']='pull-right'

    fixedform1.custom.submit['_id'] = 'id_for743'
...
def X404():
    ...
    X404form0.element('input[name=f0]')['_id']='id_for432'
    ...
    X404form0.custom.submit['_value'] = 'unk_436'
    ...
    X404form1.element('input[name=f0]')['_id']='id_for438'
    X404form1.element('input[name=f0]')['_class']='form-control'

    X404form1.custom.submit['_type'] = 'submit'
    X404form1.custom.submit['_id'] = 'id_for440'
    X404form1.custom.submit['_value'] = 'unk_442'
    ...
    X404form2.element('input[name=f0]')['_placeholder']='f0 place_447'
    X404form2.element('input[name=f0]')['_id']='id_for444'
    X404form2.element('input[name=f0]')['_class']='pull-right'
    X404form2.element('input[name=f1]')['_placeholder']='f1 place_451'
    X404form2.element('input[name=f1]')['_id']='id_for448'
    X404form2.element('input[name=f1]')['_class']='pull-right'
    X404form2.element('input[name=f2]')['_placeholder']='f2 place_455'
    X404form2.element('input[name=f2]')['_id']='id_for452'
    X404form2.element('input[name=f2]')['_class']='pull-right'
    X404form2.element('input[name=f3]')['_placeholder']='f3 place_459'
    X404form2.element('input[name=f3]')['_id']='id_for456'
    X404form2.element('input[name=f3]')['_class']='pull-right'
    X404form2.element('input[name=f4]')['_placeholder']='f4 place_463'
    X404form2.element('input[name=f4]')['_id']='id_for460'
    X404form2.element('input[name=f4]')['_class']='pull-right'

    X404form2.custom.submit['_id'] = 'id_for464'
...
def collapsed_sidebar():
    ...
    collapsed_sidebarform0 = SQLFORM(db.dcollapsed_sidebarform0, _class = 'sidebar-form', _id= 'idUnk0' )

    collapsed_sidebarform0.element('input[name=f0]')['_placeholder']='f0 Search...'
    collapsed_sidebarform0.element('input[name=f0]')['_id']='id_for252'
    collapsed_sidebarform0.element('input[name=f0]')['_class']='form-control'

    collapsed_sidebarform0.custom.submit['_type'] = 'submit'
    collapsed_sidebarform0.custom.submit['_id'] = 'search-btn'
    collapsed_sidebarform0.custom.submit['_value'] = 'unk_256'
    collapsed_sidebarform0.custom.submit['_class'] = 'btn btn-flat'
    collapsed_sidebarform0.custom.submit['_title'] = 'submit collapsed_sidebarform0'

    if collapsed_sidebarform0.accepts(request,session): 
        response.flash0 = 'submitted collapsed_sidebarform0' 
    elif collapsed_sidebarform0.errors:
        response.flash0 = '!Errors! collapsed_sidebarform0' 
    else: 
        response.flash0 = 'collapsed_sidebarform0' 



    collapsed_sidebarform1 = SQLFORM(db.dcollapsed_sidebarform1, _class = 'classUnk1', _id= 'idUnk1' )

    collapsed_sidebarform1.element('input[name=f0]')['_placeholder']='f0 place_261'
    collapsed_sidebarform1.element('input[name=f0]')['_id']='id_for258'
    collapsed_sidebarform1.element('input[name=f0]')['_class']='pull-right'
    collapsed_sidebarform1.element('input[name=f1]')['_placeholder']='f1 place_265'
    collapsed_sidebarform1.element('input[name=f1]')['_id']='id_for262'
    collapsed_sidebarform1.element('input[name=f1]')['_class']='pull-right'
    collapsed_sidebarform1.element('input[name=f2]')['_placeholder']='f2 place_269'
    collapsed_sidebarform1.element('input[name=f2]')['_id']='id_for266'
    collapsed_sidebarform1.element('input[name=f2]')['_class']='pull-right'
    collapsed_sidebarform1.element('input[name=f3]')['_placeholder']='f3 place_273'
    collapsed_sidebarform1.element('input[name=f3]')['_id']='id_for270'
    collapsed_sidebarform1.element('input[name=f3]')['_class']='pull-right'
    collapsed_sidebarform1.element('input[name=f4]')['_placeholder']='f4 place_277'
    collapsed_sidebarform1.element('input[name=f4]')['_id']='id_for274'
    collapsed_sidebarform1.element('input[name=f4]')['_class']='pull-right'

    collapsed_sidebarform1.custom.submit['_id'] = 'id_for278'
    collapsed_sidebarform1.custom.submit['_class'] = 'text-red pull-right'
    collapsed_sidebarform1.custom.submit['_title'] = 'submit collapsed_sidebarform1'

    if collapsed_sidebarform1.accepts(request,session): 
        response.flash1 = 'submitted collapsed_sidebarform1' 
    elif collapsed_sidebarform1.errors:
        response.flash1 = '!Errors! collapsed_sidebarform1' 
    else: 
        response.flash1 = 'collapsed_sidebarform1' 


    return dict( DICT= rows_dict, collapsed_sidebarform0= collapsed_sidebarform0, collapsed_sidebarform1= collapsed_sidebarform1, )
...
def index():
    ...
    indexform0.element('input[name=f0]')['_id']='id_for777'
    ...
    indexform0.custom.submit['_value'] = 'unk_781'
    ...
    indexform2.element('input[name=f0]')['_placeholder']='f0 place_792'
    indexform2.element('input[name=f0]')['_id']='id_for789'
    indexform2.element('input[name=f0]')['_class']='pull-right'
    indexform2.element('input[name=f1]')['_placeholder']='f1 place_796'
    indexform2.element('input[name=f1]')['_id']='id_for793'
    indexform2.element('input[name=f1]')['_class']='pull-right'
    indexform2.element('input[name=f2]')['_placeholder']='f2 place_800'
    indexform2.element('input[name=f2]')['_id']='id_for797'
    indexform2.element('input[name=f2]')['_class']='pull-right'
    indexform2.element('input[name=f3]')['_placeholder']='f3 place_804'
    indexform2.element('input[name=f3]')['_id']='id_for801'
    indexform2.element('input[name=f3]')['_class']='pull-right'
    indexform2.element('input[name=f4]')['_placeholder']='f4 place_808'
    indexform2.element('input[name=f4]')['_id']='id_for805'
    indexform2.element('input[name=f4]')['_class']='pull-right'

    indexform2.custom.submit['_id'] = 'id_for809'
...
def general():
    ...
    generalform0.element('input[name=f0]')['_id']='id_for526'
    ...
    generalform0.custom.submit['_value'] = 'unk_530'
    ...
    generalform1.element('input[name=f0]')['_placeholder']='f0 place_535'
    generalform1.element('input[name=f0]')['_id']='id_for532'
    generalform1.element('input[name=f0]')['_class']='pull-right'
    generalform1.element('input[name=f1]')['_placeholder']='f1 place_539'
    generalform1.element('input[name=f1]')['_id']='id_for536'
    generalform1.element('input[name=f1]')['_class']='pull-right'
    generalform1.element('input[name=f2]')['_placeholder']='f2 place_543'
    generalform1.element('input[name=f2]')['_id']='id_for540'
    generalform1.element('input[name=f2]')['_class']='pull-right'
    generalform1.element('input[name=f3]')['_placeholder']='f3 place_547'
    generalform1.element('input[name=f3]')['_id']='id_for544'
    generalform1.element('input[name=f3]')['_class']='pull-right'
    generalform1.element('input[name=f4]')['_placeholder']='f4 place_551'
    generalform1.element('input[name=f4]')['_id']='id_for548'
    generalform1.element('input[name=f4]')['_class']='pull-right'

    generalform1.custom.submit['_id'] = 'id_for552'
...
def timeline():
    ...
    timelineform0.element('input[name=f0]')['_id']='id_for681'
    ...
    timelineform0.custom.submit['_value'] = 'unk_685'
    ...
    timelineform1.element('input[name=f0]')['_placeholder']='f0 place_690'
    timelineform1.element('input[name=f0]')['_id']='id_for687'
    timelineform1.element('input[name=f0]')['_class']='pull-right'
    timelineform1.element('input[name=f1]')['_placeholder']='f1 place_694'
    timelineform1.element('input[name=f1]')['_id']='id_for691'
    timelineform1.element('input[name=f1]')['_class']='pull-right'
    timelineform1.element('input[name=f2]')['_placeholder']='f2 place_698'
    timelineform1.element('input[name=f2]')['_id']='id_for695'
    timelineform1.element('input[name=f2]')['_class']='pull-right'
    timelineform1.element('input[name=f3]')['_placeholder']='f3 place_702'
    timelineform1.element('input[name=f3]')['_id']='id_for699'
    timelineform1.element('input[name=f3]')['_class']='pull-right'
    timelineform1.element('input[name=f4]')['_placeholder']='f4 place_706'
    timelineform1.element('input[name=f4]')['_id']='id_for703'
    timelineform1.element('input[name=f4]')['_class']='pull-right'

    timelineform1.custom.submit['_id'] = 'id_for707'
...
def data():
    ...
    dataform0.element('input[name=f0]')['_id']='id_for402'
    ...
    dataform0.custom.submit['_value'] = 'unk_406'
    ...
    dataform1.element('input[name=f0]')['_placeholder']='f0 place_411'
    dataform1.element('input[name=f0]')['_id']='id_for408'
    dataform1.element('input[name=f0]')['_class']='pull-right'
    dataform1.element('input[name=f1]')['_placeholder']='f1 place_415'
    dataform1.element('input[name=f1]')['_id']='id_for412'
    dataform1.element('input[name=f1]')['_class']='pull-right'
    dataform1.element('input[name=f2]')['_placeholder']='f2 place_419'
    dataform1.element('input[name=f2]')['_id']='id_for416'
    dataform1.element('input[name=f2]')['_class']='pull-right'
    dataform1.element('input[name=f3]')['_placeholder']='f3 place_423'
    dataform1.element('input[name=f3]')['_id']='id_for420'
    dataform1.element('input[name=f3]')['_class']='pull-right'
    dataform1.element('input[name=f4]')['_placeholder']='f4 place_427'
    dataform1.element('input[name=f4]')['_id']='id_for424'
    dataform1.element('input[name=f4]')['_class']='pull-right'

    dataform1.custom.submit['_id'] = 'id_for428'
...
def inline():
    ...
    inlineform0.element('input[name=f0]')['_id']='id_for848'
    ...
    inlineform0.custom.submit['_value'] = 'unk_852'
    ...
    inlineform1.element('input[name=f0]')['_placeholder']='f0 place_857'
    inlineform1.element('input[name=f0]')['_id']='id_for854'
    inlineform1.element('input[name=f0]')['_class']='pull-right'
    inlineform1.element('input[name=f1]')['_placeholder']='f1 place_861'
    inlineform1.element('input[name=f1]')['_id']='id_for858'
    inlineform1.element('input[name=f1]')['_class']='pull-right'
    inlineform1.element('input[name=f2]')['_placeholder']='f2 place_865'
    inlineform1.element('input[name=f2]')['_id']='id_for862'
    inlineform1.element('input[name=f2]')['_class']='pull-right'
    inlineform1.element('input[name=f3]')['_placeholder']='f3 place_869'
    inlineform1.element('input[name=f3]')['_id']='id_for866'
    inlineform1.element('input[name=f3]')['_class']='pull-right'
    inlineform1.element('input[name=f4]')['_placeholder']='f4 place_873'
    inlineform1.element('input[name=f4]')['_id']='id_for870'
    inlineform1.element('input[name=f4]')['_class']='pull-right'

    inlineform1.custom.submit['_id'] = 'id_for874'
...
def profile():
    ...
    profileform0.element('input[name=f0]')['_id']='id_for468'
    ...
    profileform0.custom.submit['_value'] = 'unk_472'
    ...
    profileform2.element('input[name=f4]')['_placeholder']='f4 place_490'
    profileform2.element('input[name=f4]')['_id']='id_for487'
    ...
    profileform2.custom.submit['_id'] = 'id_for493'
    ...
    profileform2.custom.submit['_id'] = 'id_for496'
    profileform2.custom.submit['_title'] = 'submit profileform2'
    ...
    profileform3.element('input[name=f0]')['_placeholder']='f0 place_503'
    profileform3.element('input[name=f0]')['_id']='id_for500'
    profileform3.element('input[name=f0]')['_class']='pull-right'
    profileform3.element('input[name=f1]')['_placeholder']='f1 place_507'
    profileform3.element('input[name=f1]')['_id']='id_for504'
    profileform3.element('input[name=f1]')['_class']='pull-right'
    profileform3.element('input[name=f2]')['_placeholder']='f2 place_511'
    profileform3.element('input[name=f2]')['_id']='id_for508'
    profileform3.element('input[name=f2]')['_class']='pull-right'
    profileform3.element('input[name=f3]')['_placeholder']='f3 place_515'
    profileform3.element('input[name=f3]')['_id']='id_for512'
    profileform3.element('input[name=f3]')['_class']='pull-right'
    profileform3.element('input[name=f4]')['_placeholder']='f4 place_519'
    profileform3.element('input[name=f4]')['_id']='id_for516'
    profileform3.element('input[name=f4]')['_class']='pull-right'

    profileform3.custom.submit['_id'] = 'id_for520'
...
def editors():
    ...
    editorsform0.element('input[name=f0]')['_id']='id_for646'
    ...
    editorsform0.custom.submit['_value'] = 'unk_650'
    ...
    editorsform1.element('textarea[name=f0]')['_placeholder']='f0 place_654'
    ...
    editorsform2.element('textarea[name=f0]')['_id']='id_for655'
    ...
    editorsform3.element('input[name=f0]')['_placeholder']='f0 place_660'
    editorsform3.element('input[name=f0]')['_id']='id_for657'
    editorsform3.element('input[name=f0]')['_class']='pull-right'
    editorsform3.element('input[name=f1]')['_placeholder']='f1 place_664'
    editorsform3.element('input[name=f1]')['_id']='id_for661'
    editorsform3.element('input[name=f1]')['_class']='pull-right'
    editorsform3.element('input[name=f2]')['_placeholder']='f2 place_668'
    editorsform3.element('input[name=f2]')['_id']='id_for665'
    editorsform3.element('input[name=f2]')['_class']='pull-right'
    editorsform3.element('input[name=f3]')['_placeholder']='f3 place_672'
    editorsform3.element('input[name=f3]')['_id']='id_for669'
    editorsform3.element('input[name=f3]')['_class']='pull-right'
    editorsform3.element('input[name=f4]')['_placeholder']='f4 place_676'
    editorsform3.element('input[name=f4]')['_id']='id_for673'
    editorsform3.element('input[name=f4]')['_class']='pull-right'

    editorsform3.custom.submit['_id'] = 'id_for677'
...
def lockscreen():
    ...
    lockscreenform0.element('input[name=f0]')['_id']='id_for711'
    lockscreenform0.element('input[name=f0]')['_class']='form-control'

    lockscreenform0.custom.submit['_type'] = 'submit'
    lockscreenform0.custom.submit['_id'] = 'id_for713'
    lockscreenform0.custom.submit['_value'] = 'unk_715'
...
def blank():
    ...
    blankform0.element('input[name=f0]')['_id']='id_for312'
    ...
    blankform0.custom.submit['_value'] = 'unk_316'
    ...
    blankform1.element('input[name=f0]')['_placeholder']='f0 place_321'
    blankform1.element('input[name=f0]')['_id']='id_for318'
    blankform1.element('input[name=f0]')['_class']='pull-right'
    blankform1.element('input[name=f1]')['_placeholder']='f1 place_325'
    blankform1.element('input[name=f1]')['_id']='id_for322'
    blankform1.element('input[name=f1]')['_class']='pull-right'
    blankform1.element('input[name=f2]')['_placeholder']='f2 place_329'
    blankform1.element('input[name=f2]')['_id']='id_for326'
    blankform1.element('input[name=f2]')['_class']='pull-right'
    blankform1.element('input[name=f3]')['_placeholder']='f3 place_333'
    blankform1.element('input[name=f3]')['_id']='id_for330'
    blankform1.element('input[name=f3]')['_class']='pull-right'
    blankform1.element('input[name=f4]')['_placeholder']='f4 place_337'
    blankform1.element('input[name=f4]')['_id']='id_for334'
    blankform1.element('input[name=f4]')['_class']='pull-right'

    blankform1.custom.submit['_id'] = 'id_for338'
...
def morris():
    ...
    morrisform0.element('input[name=f0]')['_id']='id_for747'
    ...
    morrisform0.custom.submit['_value'] = 'unk_751'
    ...
    morrisform1.element('input[name=f0]')['_placeholder']='f0 place_756'
    morrisform1.element('input[name=f0]')['_id']='id_for753'
    morrisform1.element('input[name=f0]')['_class']='pull-right'
    morrisform1.element('input[name=f1]')['_placeholder']='f1 place_760'
    morrisform1.element('input[name=f1]')['_id']='id_for757'
    morrisform1.element('input[name=f1]')['_class']='pull-right'
    morrisform1.element('input[name=f2]')['_placeholder']='f2 place_764'
    morrisform1.element('input[name=f2]')['_id']='id_for761'
    morrisform1.element('input[name=f2]')['_class']='pull-right'
    morrisform1.element('input[name=f3]')['_placeholder']='f3 place_768'
    morrisform1.element('input[name=f3]')['_id']='id_for765'
    morrisform1.element('input[name=f3]')['_class']='pull-right'
    morrisform1.element('input[name=f4]')['_placeholder']='f4 place_772'
    morrisform1.element('input[name=f4]')['_id']='id_for769'
    morrisform1.element('input[name=f4]')['_class']='pull-right'

    morrisform1.custom.submit['_id'] = 'id_for773'
...
def icons():
    ...
    iconsform0.element('input[name=f0]')['_id']='id_for372'
    ...
    iconsform0.custom.submit['_value'] = 'unk_376'
    ...
    iconsform1.element('input[name=f0]')['_placeholder']='f0 place_381'
    iconsform1.element('input[name=f0]')['_id']='id_for378'
    iconsform1.element('input[name=f0]')['_class']='pull-right'
    iconsform1.element('input[name=f1]')['_placeholder']='f1 place_385'
    iconsform1.element('input[name=f1]')['_id']='id_for382'
    iconsform1.element('input[name=f1]')['_class']='pull-right'
    iconsform1.element('input[name=f2]')['_placeholder']='f2 place_389'
    iconsform1.element('input[name=f2]')['_id']='id_for386'
    iconsform1.element('input[name=f2]')['_class']='pull-right'
    iconsform1.element('input[name=f3]')['_placeholder']='f3 place_393'
    iconsform1.element('input[name=f3]')['_id']='id_for390'
    iconsform1.element('input[name=f3]')['_class']='pull-right'
    iconsform1.element('input[name=f4]')['_placeholder']='f4 place_397'
    iconsform1.element('input[name=f4]')['_id']='id_for394'
    iconsform1.element('input[name=f4]')['_class']='pull-right'

    iconsform1.custom.submit['_id'] = 'id_for398'
...
def top_nav():
    ...
    top_navform0 = SQLFORM(db.dtop_navform0, _class = 'navbar-form navbar-left', _id= 'idUnk0' )

    top_navform0.element('input[name=f0]')['_placeholder']='f0 Search'
    top_navform0.element('input[name=f0]')['_id']='navbar-search-input'
    top_navform0.element('input[name=f0]')['_class']='form-control'

    top_navform0.custom.submit['_type'] = 'submit'
    top_navform0.custom.submit['_id'] = 'unk-id'
    top_navform0.custom.submit['_value'] = 'submit input'
    top_navform0.custom.submit['_class'] = 'unk-class'
    top_navform0.custom.submit['_title'] = 'submit top_navform0'

    if top_navform0.accepts(request,session): 
        response.flash0 = 'submitted top_navform0' 
    elif top_navform0.errors:
        response.flash0 = '!Errors! top_navform0' 
    else: 
        response.flash0 = 'top_navform0' 


    return dict( DICT= rows_dict, top_navform0= top_navform0, )
...
def pace():
    ...
    paceform0.element('input[name=f0]')['_id']='id_for556'
    ...
    paceform0.custom.submit['_value'] = 'unk_560'
    ...
    paceform1.element('input[name=f0]')['_placeholder']='f0 place_565'
    paceform1.element('input[name=f0]')['_id']='id_for562'
    paceform1.element('input[name=f0]')['_class']='pull-right'
    paceform1.element('input[name=f1]')['_placeholder']='f1 place_569'
    paceform1.element('input[name=f1]')['_id']='id_for566'
    paceform1.element('input[name=f1]')['_class']='pull-right'
    paceform1.element('input[name=f2]')['_placeholder']='f2 place_573'
    paceform1.element('input[name=f2]')['_id']='id_for570'
    paceform1.element('input[name=f2]')['_class']='pull-right'
    paceform1.element('input[name=f3]')['_placeholder']='f3 place_577'
    paceform1.element('input[name=f3]')['_id']='id_for574'
    paceform1.element('input[name=f3]')['_class']='pull-right'
    paceform1.element('input[name=f4]')['_placeholder']='f4 place_581'
    paceform1.element('input[name=f4]')['_id']='id_for578'
    paceform1.element('input[name=f4]')['_class']='pull-right'

    paceform1.custom.submit['_id'] = 'id_for582'
...
def flot():
    ...
    flotform0.element('input[name=f0]')['_id']='id_for342'
    ...
    flotform0.custom.submit['_value'] = 'unk_346'
    ...
    flotform1.element('input[name=f0]')['_placeholder']='f0 place_351'
    flotform1.element('input[name=f0]')['_id']='id_for348'
    flotform1.element('input[name=f0]')['_class']='pull-right'
    flotform1.element('input[name=f1]')['_placeholder']='f1 place_355'
    flotform1.element('input[name=f1]')['_id']='id_for352'
    flotform1.element('input[name=f1]')['_class']='pull-right'
    flotform1.element('input[name=f2]')['_placeholder']='f2 place_359'
    flotform1.element('input[name=f2]')['_id']='id_for356'
    flotform1.element('input[name=f2]')['_class']='pull-right'
    flotform1.element('input[name=f3]')['_placeholder']='f3 place_363'
    flotform1.element('input[name=f3]')['_id']='id_for360'
    flotform1.element('input[name=f3]')['_class']='pull-right'
    flotform1.element('input[name=f4]')['_placeholder']='f4 place_367'
    flotform1.element('input[name=f4]')['_id']='id_for364'
    flotform1.element('input[name=f4]')['_class']='pull-right'

    flotform1.custom.submit['_id'] = 'id_for368'
...
def chartjs():
    ...
    chartjsform0.element('input[name=f0]')['_id']='id_for616'
    ...
    chartjsform0.custom.submit['_value'] = 'unk_620'
    ...
    chartjsform1.element('input[name=f0]')['_placeholder']='f0 place_625'
    chartjsform1.element('input[name=f0]')['_id']='id_for622'
    chartjsform1.element('input[name=f0]')['_class']='pull-right'
    chartjsform1.element('input[name=f1]')['_placeholder']='f1 place_629'
    chartjsform1.element('input[name=f1]')['_id']='id_for626'
    chartjsform1.element('input[name=f1]')['_class']='pull-right'
    chartjsform1.element('input[name=f2]')['_placeholder']='f2 place_633'
    chartjsform1.element('input[name=f2]')['_id']='id_for630'
    chartjsform1.element('input[name=f2]')['_class']='pull-right'
    chartjsform1.element('input[name=f3]')['_placeholder']='f3 place_637'
    chartjsform1.element('input[name=f3]')['_id']='id_for634'
    chartjsform1.element('input[name=f3]')['_class']='pull-right'
    chartjsform1.element('input[name=f4]')['_placeholder']='f4 place_641'
    chartjsform1.element('input[name=f4]')['_id']='id_for638'
    chartjsform1.element('input[name=f4]')['_class']='pull-right'

    chartjsform1.custom.submit['_id'] = 'id_for642'
...
def sliders():
    ...
    slidersform0.element('input[name=f0]')['_id']='id_for586'
    ...
    slidersform0.custom.submit['_value'] = 'unk_590'
    ...
    slidersform1.element('input[name=f0]')['_placeholder']='f0 place_595'
    slidersform1.element('input[name=f0]')['_id']='id_for592'
    slidersform1.element('input[name=f0]')['_class']='pull-right'
    slidersform1.element('input[name=f1]')['_placeholder']='f1 place_599'
    slidersform1.element('input[name=f1]')['_id']='id_for596'
    slidersform1.element('input[name=f1]')['_class']='pull-right'
    slidersform1.element('input[name=f2]')['_placeholder']='f2 place_603'
    slidersform1.element('input[name=f2]')['_id']='id_for600'
    slidersform1.element('input[name=f2]')['_class']='pull-right'
    slidersform1.element('input[name=f3]')['_placeholder']='f3 place_607'
    slidersform1.element('input[name=f3]')['_id']='id_for604'
    slidersform1.element('input[name=f3]')['_class']='pull-right'
    slidersform1.element('input[name=f4]')['_placeholder']='f4 place_611'
    slidersform1.element('input[name=f4]')['_id']='id_for608'
    slidersform1.element('input[name=f4]')['_class']='pull-right'

    slidersform1.custom.submit['_id'] = 'id_for612'
...
def calendar():
    ...
    calendarform0.element('input[name=f0]')['_id']='id_for944'
    ...
    calendarform0.custom.submit['_value'] = 'unk_948'
    ...
    calendarform1.element('input[name=f0]')['_placeholder']='f0 place_953'
    calendarform1.element('input[name=f0]')['_id']='id_for950'
    calendarform1.element('input[name=f0]')['_class']='pull-right'
    calendarform1.element('input[name=f1]')['_placeholder']='f1 place_957'
    calendarform1.element('input[name=f1]')['_id']='id_for954'
    calendarform1.element('input[name=f1]')['_class']='pull-right'
    calendarform1.element('input[name=f2]')['_placeholder']='f2 place_961'
    calendarform1.element('input[name=f2]')['_id']='id_for958'
    calendarform1.element('input[name=f2]')['_class']='pull-right'
    calendarform1.element('input[name=f3]')['_placeholder']='f3 place_965'
    calendarform1.element('input[name=f3]')['_id']='id_for962'
    calendarform1.element('input[name=f3]')['_class']='pull-right'
    calendarform1.element('input[name=f4]')['_placeholder']='f4 place_969'
    calendarform1.element('input[name=f4]')['_id']='id_for966'
    calendarform1.element('input[name=f4]')['_class']='pull-right'

    calendarform1.custom.submit['_id'] = 'id_for970'
...
def index2():
    ...
    index2form0.element('input[name=f0]')['_id']='id_for813'
    ...
    index2form0.custom.submit['_value'] = 'unk_817'
    ...
    index2form2.element('input[name=f0]')['_placeholder']='f0 place_827'
    index2form2.element('input[name=f0]')['_id']='id_for824'
    index2form2.element('input[name=f0]')['_class']='pull-right'
    index2form2.element('input[name=f1]')['_placeholder']='f1 place_831'
    index2form2.element('input[name=f1]')['_id']='id_for828'
    index2form2.element('input[name=f1]')['_class']='pull-right'
    index2form2.element('input[name=f2]')['_placeholder']='f2 place_835'
    index2form2.element('input[name=f2]')['_id']='id_for832'
    index2form2.element('input[name=f2]')['_class']='pull-right'
    index2form2.element('input[name=f3]')['_placeholder']='f3 place_839'
    index2form2.element('input[name=f3]')['_id']='id_for836'
    index2form2.element('input[name=f3]')['_class']='pull-right'
    index2form2.element('input[name=f4]')['_placeholder']='f4 place_843'
    index2form2.element('input[name=f4]')['_id']='id_for840'
    index2form2.element('input[name=f4]')['_class']='pull-right'

    index2form2.custom.submit['_id'] = 'id_for844'
...
def X500():
    ...
    X500form0.element('input[name=f0]')['_id']='id_for908'
    ...
    X500form0.custom.submit['_value'] = 'unk_912'
    ...
    X500form1.element('input[name=f0]')['_id']='id_for914'
    X500form1.element('input[name=f0]')['_class']='form-control'

    X500form1.custom.submit['_type'] = 'submit'
    X500form1.custom.submit['_id'] = 'id_for916'
    X500form1.custom.submit['_value'] = 'unk_918'
    ...
    X500form2.element('input[name=f0]')['_placeholder']='f0 place_923'
    X500form2.element('input[name=f0]')['_id']='id_for920'
    X500form2.element('input[name=f0]')['_class']='pull-right'
    X500form2.element('input[name=f1]')['_placeholder']='f1 place_927'
    X500form2.element('input[name=f1]')['_id']='id_for924'
    X500form2.element('input[name=f1]')['_class']='pull-right'
    X500form2.element('input[name=f2]')['_placeholder']='f2 place_931'
    X500form2.element('input[name=f2]')['_id']='id_for928'
    X500form2.element('input[name=f2]')['_class']='pull-right'
    X500form2.element('input[name=f3]')['_placeholder']='f3 place_935'
    X500form2.element('input[name=f3]')['_id']='id_for932'
    X500form2.element('input[name=f3]')['_class']='pull-right'
    X500form2.element('input[name=f4]')['_placeholder']='f4 place_939'
    X500form2.element('input[name=f4]')['_id']='id_for936'
    X500form2.element('input[name=f4]')['_class']='pull-right'

    X500form2.custom.submit['_id'] = 'id_for940'
